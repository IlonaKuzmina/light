...
import { categories, equipmentData } from "../utils/products";
        ...
        <div className="mb-12 flex flex-wrap gap-4 sm:mb-16 sm:gap-6">
          {categories.map((category) => (
            <button
              ...
              className={`hover:bg-light h-10 cursor-pointer rounded-full px-4 text-base font-normal transition-all hover:text-[#070707] ${
              ...
              >
                ...
                <div className="flex gap-4 lg:gap-6 w-full">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="flex-1 !text-sm !h-12 !px-4 !font-bold"
                  >
                    Request Pricing
                  </Button>
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 !text-sm !h-12 !px-4 !font-normal"
                  >
                    Technical Data
                  </Button>
                </div>
